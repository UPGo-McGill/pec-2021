...
figure_1_7_fun <- function(regular = "", condensed = "") {
  ...
  ML %>% 
    filter(date >= "2017-06-01", date <= "2021-11-30") %>% 
    ggplot() +
...
In 2021, `r ml_listings` of active listings in Prince Edward County were multilistings, earning `r ml_revenue` of total host revenue. Multilistings had been growing steadily since 2018, both in terms of listings and revenue percentage, until the Covid-19 pandemic, when their proportion dropped somewhat (Figure \@ref(fig:fig-1-7)). Still, through the fall of 2021 multilistings were earning close to 5 out of every 10 dollars on STR platforms in Prince Edward County. 

...
# Weighted average to compare with rents
LTM_revenue_ward <- 
...
weight_rent_sept[weight_rent_sept$ward == "Bloomfield",]$weight),
weighted.mean(weight_revenue_ward[weight_revenue_ward$ward == "Wellington",]$mean_rev,
weight_rent_sept[weight_rent_sept$ward == "Wellington",]$weight),
weighted.mean(weight_revenue_ward[weight_revenue_ward$ward == "Township",]$mean_rev,
weight_rent_sept[weight_rent_sept$ward == "Township",]$weight),
weighted.mean(weight_revenue_ward[weight_revenue_ward$ward == "Picton",]$mean_rev,
weight_rent_sept[weight_rent_sept$ward == "Picton",]$weight)))

surplus_rent <- 
LTM_revenue_ward %>% 
  left_join(rent_wards) %>% 
  mutate(surplus = round(mean_rev - rent, -1)) %>% 
  st_as_sf()

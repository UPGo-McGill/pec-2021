...
#   ggplot(df, aes(label = group, fill = group, values = value)) +
#   geom_pictogram(color = "white", size = 5, n_rows = 8) +
#   scale_label_pictogram(
#     name = NULL,
#     values = c("Moved from FT to home sharing" = "home", 
#                "Existing home sharing" = "home")) +
...
# 
# waffle_legend <- 
#   cowplot::get_legend(themes_waffle(waffle_df, NA) + 

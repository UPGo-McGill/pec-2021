...
(ref:fig-4-1) _Percentage of homeowners' housing stress by dissemination area (R) and ward (L)_
...
(ref:fig-4-2) _Monthly number of property sales in Prince Edward County_
...
(ref:fig-4-3) _Year-over-year changes in monthly real estate sales and average sale prices_
...
figure_4_5_fun <- function(regular = "", condensed = "") {
...
(ref:fig-4-4) _Monthly averages of days on the market_

``` {r fig-4-5, include = TRUE, fig.cap = '(ref:fig-4-5)', fig.align = "center"}

figure_4_5_fun()

```

(ref:fig-4-5) _Monthly difference between asking and sale prices_
...
## Affording to be a homeowner in Prince Edward County
...
figure_4_6_fun <- function(regular = "", condensed = "") {

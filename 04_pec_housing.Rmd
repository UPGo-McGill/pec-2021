...
if (build_figures) {
  ggsave(here("output", "figures", "figure_4_4.pdf"), 
         ...
         width = 12, height = 4.2, units = "in", useDingbats = FALSE)
...
(ref:fig-4-4) _Monthly averages for days on the market (right) and difference between asking and sale prices (left)_
...
(ref:fig-4-5) _Average sale prices by ward from 2016 to 2021_

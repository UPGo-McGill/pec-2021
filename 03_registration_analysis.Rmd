...
Given the previous discussion, there are two plausible candidates for this external factor. First, the fact that the County has put a moratorium on STA registrations means that it has been illegal to operate a new STA since September 2020. Potential STA hosts may have decided to delay or cancel their plans to open a new STA because they wish to follow the law. We can test this possibility by examining the creation of new STA listings before and after the moratorium came into effect; if the moratorium is a significant driver of STA host behaviour, there will be a discontinuity in this behaviour around the moratorium start date. Second, it is possible that possible new STAs have been crowded out by second-home sales. This could occur if potential STA hosts have been unable to purchase properties to convert to STAs because, even at the higher prevailing nightly prices, they cannot justify the prices which second-home purchasers are willing to pay. We can test this possibility by comparing STA nightly prices with home sales prices to see if STAs are becoming more or less lucrative, relative to the cost of housing.

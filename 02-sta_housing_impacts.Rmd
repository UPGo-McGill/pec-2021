...
figure_2_13_fun <- function(regular = "", condensed = "") {
...
if (build_figures) {
  ggsave(here("output", "figures", "figure_2_13.pdf"), 
         plot = figure_2_13_fun("Futura", "Futura Condensed"), 
         width = 9, height = 4.2, units = "in", useDingbats = FALSE)
  
  extrafont::embed_fonts(here("output", "figures", "figure_2_13.pdf"))
}

```


``` {r fig-2-13, include = TRUE, fig.cap = '(ref:fig-2-13)', fig.align = "center"}

...
rm(annual_avg_rent, annual_units, annual_vacancy, LA, LA_raw,
   ...
   figure_3_4, figure_3_5, figure_3_6, FREH_area, FREH_DA, FREH_total,
   GH_area, GH_DA, GH_total, housing_loss, housing_loss_area,

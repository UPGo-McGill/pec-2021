...
```
(ref:fig-4-1) _Housing units converted to dedicated STRs in the Prince Edward County_
...
```
(ref:fig-4-2) _Housing units operating on a full-time basis on the STR market of the Prince Edward County, per season_
...
(ref:fig-4-3) _The percentage of active STR listings contributing to long-term housing loss each day in PEC (14-day average)_
